...
(function initSearch() {
  ...
  const PAGES = [
    ...
    { title:'Diagnóstico Seguro',   desc:'Indemnización ante enfermedades graves',           url: base+'servicios/diagnostico-seguro.html',   tags:'diagnostico enfermedad cancer acv infarto renal trasplante grave indemnizacion' },
    { title:'Cobertura Exequial',   desc:'Asistencia funeraria e inhumación',                url: base+'servicios/exequial.html',             tags:'exequial funeraria sepelio inhumacion cremacion' },
    { title:'Riesgos Generales',    desc:'Coberturas para empresas y proyectos',             url: base+'riesgos-generales.html',              tags:'riesgos generales empresa incendio fianzas maquinaria responsabilidad' },
